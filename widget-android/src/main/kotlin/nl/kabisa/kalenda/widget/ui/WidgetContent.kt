...
private val BackgroundColor = ColorProvider(Color(0xCC1C1C1E))
...
private fun ScrollableContent(dayGroups: List<DayGroup>, deviceTimezone: TimeZone) {
    LazyColumn(modifier = GlanceModifier.fillMaxSize().padding(vertical = 8.dp)) {
...
private fun CompactContent(dayGroups: List<DayGroup>, deviceTimezone: TimeZone) {
    Column(modifier = GlanceModifier.fillMaxSize().padding(vertical = 8.dp)) {
